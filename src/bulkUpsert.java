 ...
 *
 */
@WebServlet("/bulkUpsert")
public class bulkUpsert extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (decryptedData != null) {
            ...
            if (decryptedData.has("body")) {
                ...
                SignatureBuilder bulkUpserts = new SignatureBuilder(
                ...
                try {
                    bulkUpserts.makePostRequest();
                } finally {
                    // Successful request will respond with a page that says successful
                    if (bulkUpserts.getStatus() == 200 || bulkUpserts.getStatus() == 202) {
                        PrintWriter out = response.getWriter();
                        out.print(bulkUpserts.successfulRequest());
